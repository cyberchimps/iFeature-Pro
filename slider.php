...
*/
    	...
    	query_posts( array ('post_type' => 'if_custom_slides') );
	    ...
	    if (have_posts()) :
	    	...
	    	if ($customimage != '' && $usecustomslides != 'posts' && $hidetitlebar == 'on') { 
	       		...
	       		$out .= "<a href='$customlink'>	
	    						<img src='./wp-content/themes/ifeaturepro/images/pro/ifeaturepro.jpg' alt='iFeaturePro' />
	       ...
	       elseif ($image != '' && $usecustomslides == 'posts'){
	         ...
	         elseif ($image == '' && $usecustomslides == 'posts' && $hidetitlebar == 'on'){
	    		...
	    		$out .= "<a href='$permalink'>	
	    						<img src='./wp-content/themes/ifeaturepro/images/pro/ifeaturepro.jpg' />
	    						<span>
	    							<strong>$title</strong><br />
	    							$text
	    						</span>
