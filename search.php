...
<div id="content">
<?php if ( have_posts() ) : ?>
<h1 class="page-title"><?php _e( 'Search Results for: ', 'ifp' ); ?><span><?php the_search_query(); ?></span></h1>
...
<h2 class="entry-title"><?php _e( 'Nothing Found', 'ifp' ) ?></h2>
<div class="entry-content">
<p><?php _e( 'Sorry, nothing matched your search. Please try again.', 'ifp' ); ?></p>
<?php get_search_form(); ?>
</div>
</div>
<?php endif; ?>
