...
add_action('wp_head', 'ifeature_lazy_load');
...
function ifp_widgets_init() {
    ...
    register_sidebar(array(
		...
		'before_widget' => '<div id="box1" class="span4"><div class="box_wrap">',
	...
	register_sidebar(array(
		...
		'before_widget' => '<div id="box2" class="span4"><div class="box_wrap">',
		'after_widget' => '</div></div>',
		'before_title' => '<h3 class="box-widget-title">',
		'after_title' => '</h3>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div id="box3" class="span4"><div class="box_wrap">',
		'after_widget' => '</div></div>',
		'before_title' => '<h3 class="box-widget-title">',
		'after_title' => '</h3>',
	));
