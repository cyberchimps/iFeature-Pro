...
function ifp_widgets_init() {
    ...
    register_sidebar(array(
 	...
 	register_sidebar(array(
		...
		'before_widget' => '<div id="box1" class="four columns %2$s"><div class="box_wrap">',
	...
	register_sidebar(array(
		...
		'before_widget' => '<div id="box2" class="four columns %2$s"><div class="box_wrap">',
		'after_widget' => '</div></div>',
		'before_title' => '<h3 class="box-widget-title">',
		'after_title' => '</h3>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div id="box3" class="four columns %2$s"><div class="box_wrap">',
		'after_widget' => '</div></div>',
		'before_title' => '<h3 class="box-widget-title">',
		'after_title' => '</h3>',
	));
