...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		->open_outersection()
			->section_order("blog_section_order", "Blog Page Re-Order", array('options' => array("blog_loop" => "Post Loop", "chimps_blog_slider" => "iFeature Slider", "chimps_blog_callout" => "Callout Section", "chimps_blog_twitterbar" => "Twitter Bar", "chimps_blog_carousel" => "Carousel", "chimps_blog_boxes" => "Widgetized Boxes")))
		->close_outersection()
	...
	->section("Templates")
		->subsection("Single Post")
			...
			->multicheck($themeslug."_single_hide_byline", "Post Byline Elements", array( 'options' => array($themeslug."_single_hide_author" => "Author" , $themeslug."_single_hide_categories" => "Categories", $themeslug."_single_hide_date" => "Date", $themeslug."_single_hide_comments" => "Comments", $themeslug."_single_hide_share" => "Share", $themeslug."_single_hide_tags" => "Tags"), 'default' => array( $themeslug."_single_hide_tags" => true, $themeslug."_single_hide_share" => true, $themeslug."_single_hide_author" => true, $themeslug."_single_hide_date" => true, $themeslug."_single_hide_comments" => true, $themeslug."_single_hide_categories" => true ) ) )
