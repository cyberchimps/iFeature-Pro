...
")
	...
	->section("Header")
		->open_outersection()
			->section_order("header_section_order", "Drag drop sections for the Header", array('options' => array("ifeature_header_content" => "Header Content", "synapse_navigation" => "Navigation", "ifeature_sitename_register" => "Sitename/Login"), 'default' => 'ifeature_header_content,synapse_navigation'))
		->close_outersection()
