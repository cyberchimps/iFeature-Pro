...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		->open_outersection()
			->section_order($themeslug."_blog_section_order", "Blog Page Re-Order", array('options' => array("chimps_pro_index" => "Post Page", "chimps_blog_slider" => "iFeature Slider", "chimps_blog_callout" => "Callout Section", "chimps_blog_twitterbar" => "Twitter Bar", "chimps_index_carousel_section" => "Carousel", "chimps_box_section" => "Boxes"), "default" => "chimps_pro_index"))
		->close_outersection()
