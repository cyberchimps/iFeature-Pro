...
$options
	...
	->section("Blog")
		->subsection("Blog")
			...
			->multicheck($themeslug."_hide_byline", "Hide Post Byline Elements", array( 'options' => array("key1" => "Author", "key2" => "Categories", "date" => "Date", "key4" => "Comments", "key5" => "Share", "key6" => "Tags")))
