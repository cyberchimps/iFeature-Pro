<?php
/**
* Content Slider Element actions used by iFeature Pro
*
...
add_action ('synapse_content_slider', 'synapse_content_slider_content' );

/**
* Extend slider functions
*/
function synapse_content_slider_content() {
...
/* End slider width variable */ 
	...
	query_posts( array ('post_type' => $themeslug.'_content_slides', 'showposts' => 100,  'content_slide_categories' => $customcategory  ) );
