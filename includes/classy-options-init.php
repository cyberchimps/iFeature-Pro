...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		...
		->subsection("Blog Options")
			...
			->checkbox($themeslug."_show_twitter", "Twitter Tweet Button")
		->subsection_end()
	...
	->section("Templates")
		->subsection("Single Post")
			...
			->checkbox($themeslug."_single_show_twitter", "Twitter Tweet Button")
		...
		->subsection("Archive")
			...
			->checkbox($themeslug."_archive_show_twitter", "Twitter Tweet Button")
			->subsection_end()
		->subsection("Search")
