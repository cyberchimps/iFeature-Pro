...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		->open_outersection()
			->section_order($themeslug."_blog_section_order", "Drag & Drop Blog Elements", array('options' => array("synapse_index" => "Post Page", "synapse_blog_slider" => "iFeature Slider",  "synapse_callout_section" => "Callout Section", "synapse_twitterbar_section" => "Twitter Bar", "synapse_index_carousel_section" => "Carousel", "synapse_box_section" => "Boxes", "synapse_blog_nivoslider" => "NivoSlider", "synapse_portfolio_element" => "Portfolio", "synapse_custom_html_element" => "Custom HTML", "synapse_product_element" => "Product"), "default" => 'synapse_blog_slider,synapse_index'))
		->close_outersection()
		...
		->subsection("Content Slider")
			->select($themeslug.'_blog_content_slider_category', 'Custom slide category', array( 'options' => $content_slider ))
			->text($themeslug."_blog_content_slider_height", "Slider height", array('default' => '300'))
			->text($themeslug."_blog_content_slider_delay", "Slider Delay", array('default' => '3500'))
			->select($themeslug."_blog_content_slider_animation", "Slider Animation", array( 'options' => array("key1" => "Horizontal-Push", "key2" => "Fade", "key3" => "Horizontal-Slide", "key4" => "Vertical-Slide")))
			->select($themeslug."_blog_content_slider_nav", "Slider Navigation", array( 'options' => array("key1" => "Dots", "key3" => "none")))
			->checkbox($themeslug."_blog_content_slider_arrows", "Slider Arrows", array('default' => true))
			->checkbox($themeslug."_blog_content_slider_wordthumb", "WordThumb Image Resizing")
		->subsection_end()
